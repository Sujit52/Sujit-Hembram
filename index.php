...
<head>
    ...
    <title>!! BANK BOOSTER BY SDK_SUJIT!!</title>
...
echo" <form action='' method='POST'>
    ...
    <input type='int' name='mobile' class='input' placeholder='Enter Unregistered Number' required>
    <input type='submit' name='submit' class='button shine' value='Send Otp'>
        </form>";

    
}

 #PHP File Created By Titanium_Loots#
...
$url="https://cricket6.in/user/auth/login";
    
    $data='{"phone_no":"'.$mobile.'","phone_code":"91","device_type":"3","device_id":"","otp_hash":null,"source":"","medium":"","campaign":"","term":"","content":"","token":"HFYnFqcQhOKCwtd0FfTFtOTR4CJhsvbXFuGh0wPWwIIx4CMDQeN207PBVGcCtKISw3MjB8BgIZS0RUSCIWVBhpFxgHTng1WGNbXmMsHX9bMy96U387QGJ1KDYrEgJoBgIZSn5THER-GnpuBEtnJWNLa381eld4bmBPEQE_cQ9PPTsqVQ"}';
    
    
    $usertoken=''.$three.'7f0d'.$four.'ece0ef9';
    $headers= [
    'Host: cricket6.in',
'content-length: 340',
...
if($code==="OTP sent on your phone is valid for 30 seconds only.")
{
	
	
echo"<div class='msg success'>Otp Sent Successfully </div>";
echo"<form action='otp.php' method='POST'>
	<input type='hidden' value='$mobile' name='mobile'> 
	
    <input type='tel' name='otp' class='input' placeholder='Enter Your Otp' required>
    <input type='submit' name='submit' class='button shine' value='Verify Otp'>
        </form>";
...
<a href="https://instagram.com/sujithembram52" class="telBtn">
    <i class="fa-regular fa-paper-plane"></i><span>BY SDK_SUJIT</span>
</a>
  </div>
</body>
</html>